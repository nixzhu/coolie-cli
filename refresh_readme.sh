...
echo "$ .build/release/coolie-cli -i test.json --model-name User --argument-label json --parameter-name info"
echo "\`\`\`"
echo
...
echo
echo "\`\`\` bash"
echo "$ .build/release/coolie-cli -i test.json --model-name User --constructor-name create --argument-label with --parameter-name json --json-dictionary-name JSONDictionary"
echo "\`\`\`"
echo
echo "It will generate:"
echo
...
echo
echo "\`\`\` bash"
echo "$ .build/release/coolie-cli -i test.json --model-name User --model-type class"
echo "\`\`\`"
echo
echo "\`\`\` swift"
